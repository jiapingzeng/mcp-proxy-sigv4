...
class TestProxyServer:
    ...
    def test_create_transport_with_sigv4(self, mock_sigv4_auth):
        ...
        with patch('mcp_proxy_sigv4.proxy.SigV4StreamableHttpTransport') as mock_transport:
            mock_transport_instance = Mock()
            mock_transport.return_value = mock_transport_instance
    ...
    async def test_run_stdio_exception(self):
        ...
        with patch.object(server, '_create_transport', side_effect=Exception("Test error")):

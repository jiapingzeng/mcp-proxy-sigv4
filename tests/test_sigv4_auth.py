...
class TestSigV4Auth:
    ...
    def test_auth_inherits_from_aws4auth(self, mock_boto3_session, mock_aws_credentials):
    ...
    def test_aws4auth_initialization(self, mock_aws4auth_init, mock_boto3_session, mock_aws_credentials):
...
class TestSigV4StreamableHttpTransport:
    ...
    def test_init_with_sigv4_auth(self):
        ...
        with patch('mcp_proxy_sigv4.sigv4_auth.StreamableHttpTransport.__init__') as mock_parent_init:
            mock_parent_init.return_value = None

            SigV4StreamableHttpTransport(
                url="https://example.com/mcp",
                sigv4_auth=mock_auth,
                timeout=60.0
            )
